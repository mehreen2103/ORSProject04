...
/**
 * RoleListCtl Controller.
 * 
 * Handles search, pagination, delete, and list operations for Role entity.
...
public class RoleListCtl extends BaseCtl {
    ...
    /**
     * Preloads role list for dropdown or filter use.
     *
    ...
    /**
     * Populates RoleBean using request parameters for searching.
     *
     * @param request HttpServletRequest
    ...
    /**
     * Handles GET request to show initial Role list.
     *
     * @param request HttpServletRequest
    ...
    /**
     * Returns the Role list view page.
     *
     * @return path of ROLE_LIST_VIEW
     */
    @Override
