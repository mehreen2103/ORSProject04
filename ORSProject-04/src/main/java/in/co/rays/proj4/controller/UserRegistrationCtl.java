 ...
 * 
 * Handles user registration validation, form submission, signup operation,
 * and resetting the registration form.
 * 
 * @author mehre
 * @version 1.0
 */
...
public class UserRegistrationCtl extends BaseCtl {
     ...
     * 
     * @param request HttpServletRequest
     * @return UserBean populated with form inputs
     */
    @Override
    ...
    /**
     * Handles Sign Up and Reset operations.
     * 
     * @param request HttpServletRequest
     * @param response HttpServletResponse
     */
    ...
    /**
     * Returns the view for user registration page.
     * 
