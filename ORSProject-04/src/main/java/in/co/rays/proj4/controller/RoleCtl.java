 ...
 * RoleCtl Controller.
 * 
 * Handles Add, Update, Reset, Cancel operations for Role entity.
 * 
 * @author mehre 
 * @version 1.0
 */
...
public class RoleCtl extends BaseCtl {
    ...
    /**
     * Handles GET request.
     * Loads Role data when id is provided.
     *
    ...
    /**
     * Handles POST operations like Save, Update, Reset, Cancel.
     *
     * @param request HttpServletRequest
     * @param response HttpServletResponse
     */
    ...
    /**
     * Returns the view page for Role form.
     *
